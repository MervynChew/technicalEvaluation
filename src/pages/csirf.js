  ...
  return (
    <>
      ...
      <div class='event-detail-frame'>
        <div>
          <p class='title-event'>Computer Science Internship & Recruitment Fair 2022</p>
          ...
          <div className="event-detail-wrapper">
            ...
            <div className="event-details">
              ...
              <span>9:00am - 6:00pm (GMT+8)</span>
              <span>Dewan Utama Pelajar, USM</span>
            </div>
          </div>
        </div>
        <img src='./EventPic/csirf2022.webp' class='event-picture'></img>
      </div>
      <div class='event-detail-description-box'>
        <p class='event-detail-description'>Description:</p>
        <p>Computer Science Internship and Recruitment Fair (CSIRF) 2022 is a 2-day event featuring career talks and exhibitions for undergraduate students at USM. This annual event has been successful in securing internships and employment offers for students in the past.</p>
        <br></br>
        <p>This year, the event will be conducted in-person on the USM campus, providing students with an opportunity to learn about potential internship and job opportunities from participating companies. CS Society will develop a custom website for job postings and applications.</p>
        <br></br>
        <p>CSIRF 2022 is open to all USM Computer Science students who are interested in joining the career talks and exhibitions. It is a valuable opportunity for participating companies to promote themselves to a wider audience of potential recruits, and for students to gain insights and connections that can help them launch their careers in the tech industry.</p>
      </div>
      <Footer2 />
    </>
  );
