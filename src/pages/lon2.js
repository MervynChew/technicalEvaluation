  ...
  return (
    <>
      ...
      <div class='event-detail-frame'>
        <div>
          <p class='title-event'>Log Off Night 2023</p>
          ...
          <div className="event-detail-wrapper">
            ...
            <div className="event-details">
              <span>14th July 2023</span>
              <span>7:00pm - 11:00pm (GMT+8)</span>
              <span>AC Hotel by Marriott Penang</span>
            </div>
          </div>
        </div>
        <img src='./EventPic/LON2023.webp' class='event-picture'></img>
      </div>
      <div class='event-detail-description-box'>
        <p class='event-detail-description'>Description:</p>
        <p>Log Off Night is an event to commemorate the end of the 2022/2023 academic year for all Computer Science students and holds immense significance for our final-year students, celebrating their accomplishments and bidding them farewell on their paths towards greater heights.</p>
      </div>
      <Footer2 />
    </>
  );
