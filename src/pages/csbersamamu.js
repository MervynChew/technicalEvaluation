  ...
  return (
    <>
      ...
      <div class='event-detail-frame'>
        <div>
          <p class='title-event'>CS Bersamamu 2023</p>
          ...
          <div className="event-detail-wrapper">
            ...
            <div className="event-details">
              <span>22nd October 2023</span>
              <span>9:30pm - 5:30pm (GMT+8)</span>
              <span>DK G31, School of Computer Sciences, USM</span>
            </div>
          </div>
        </div>
        <img src='./EventPic/csbersamamu.webp' class='event-picture'></img>
      </div>
      <div class='event-detail-description-box'>
        ...
        <br></br>
        <p>This year, a series of engaging events took place, such as senior sharing session, booth exhibitions, recreational activities, and a hackathon session, all aimed at fostering camaraderie and facilitating a smooth transition into university life.</p>
      </div>
      <Footer2 />
    </>
  );
...
export default CSBersamamuDetails;