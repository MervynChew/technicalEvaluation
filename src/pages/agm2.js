  ...
  return (
    <>
      ...
      <div class='event-detail-frame'>
        <div>
          <p class='title-event'>Annual General Meeting 2023</p>
          ...
          <div className="event-detail-wrapper">
            ...
            <div className="event-details">
              ...
              <span>8:00pm - 11:00pm (GMT+8)</span>
              <span>Online</span>
            </div>
          </div>
        </div>
        <img src='./EventPic/Agm2023.webp' class='event-picture'></img>
      </div>
      <div class='event-detail-description-box'>
        <p class='event-detail-description'>Description:</p>
        <p>The Annual General Meeting (AGM) is an annual event of CS Society aimed to showcase the achievements of the CS Society throughout the academic year and election is done to elect the new Executive Members for the next academic session.</p>
        <br></br>
        <p>The annual activity report showcases the events that CS Society has organised throughout the academic session. Get a glimpse of the behind-the-scenes action, the dedication and the hard work put in by the committees.</p>
        <br></br>
        <p>The CS Society Board Election is your chance to make your voice heard and vote for the new Top Committee members of CS Society, who will shoulder the responsibilities of leading the student body toward greater heights.</p>
      </div>
      <Footer2 />
    </>
  );
