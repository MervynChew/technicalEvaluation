  ...
  return (
    <>
      ...
      <div class='event-detail-frame'>
        <div>
          <p class='title-event'>CS Bersamamu 2022</p>
          ...
          <div className="event-detail-wrapper">
            ...
            <div className="event-details">
              <span>29th October 2022</span>
              <span>8:00pm - 11:10pm (GMT+8)</span>
              <span>Online</span>
            </div>
          </div>
        </div>
        <img src='./EventPic/csbersamamu2022.webp' class='event-picture'></img>
      </div>
      <div class='event-detail-description-box'>
        <p class='event-detail-description'>Description:</p>
        <p>CS Bersamamu is an annual event that is organized by the senior committees from CS Society for the first-year students from School of Computer Sciences, USM. This program aims to prepare the first-year students for university life and establish a platform for them to get to know their course mates, lecturers, and the whole CS community.</p>
        <br></br>
        <p>Activities including the ice-breaking session, station games and sharing session are included to strengthen their bond to ease their first step into university.</p><br></br>
        <p>Stay tuned on event updates on this page and in our social media!</p>
      </div>
      <Footer2 />
    </>
  );
...
export default CSBersamamu2Details;