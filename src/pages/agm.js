  ...
  return (
    <>
      ...
      <div class='event-detail-frame'>
        <div>
          <p class='title-event'>Annual General Meeting 2024</p>
          ...
          <div className="event-detail-wrapper">
            ...
            <div className="event-details">
              ...
              <span>7:50pm - 10:45pm (GMT+8)</span>
              <span>Online</span>
            </div>
          </div>
        </div>
        <img src='./EventPic/Agm.webp' class='event-picture'></img>
      </div>
