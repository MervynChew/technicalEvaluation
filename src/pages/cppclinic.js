  ...
  return (
    <>
      ...
      <div class='event-detail-frame'>
        <div>
          <p class='title-event'>C++ Clinic 2023</p>
          ...
          <div className="event-detail-wrapper">
            ...
            <div className="event-details">
              <span>27th & 28th January 2023</span>
              <span>8:00pm - 10:30pm (GMT+8)</span>
              <span>Online</span>
            </div>
          </div>
        </div>
        <img src='./EventPic/cppclinic2023.webp' class='event-picture'></img>
      </div>
      <div class='event-detail-description-box'>
        <p class='event-detail-description'>Description:</p>
        <p>An online C++ coding workshop involving first-year computer science students from Universiti Sains Malaysia (USM). Through this workshop, the students’ programming skills can be sharpened to further empower their technical skills and understanding in preparation for their final exam.</p>
      </div>
      <Footer2 />
    </>
  );
...
export default CppclinicDetails;