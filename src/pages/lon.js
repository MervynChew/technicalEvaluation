  ...
  return (
    <>
      ...
      <div class='event-detail-frame'>
        <div>
          <p class='title-event'>Log Off Night 2024</p>
          ...
          <div className="event-detail-wrapper">
            ...
            <div className="event-details">
              ...
              <span>Bayview Hotel, George Town, Penang</span>
            </div>
          </div>
        </div>
        <img src='./EventPic/LON.webp' class='event-picture'></img>
      </div>
      <div class='event-detail-description-box'>
        <p class='event-detail-description'>Description:</p>
        <p>Log Off Night is the epic celebration marking the end of the 2023/2024 academic year for all Computer Science students! It’s a night where we come together to celebrate our achievements, honor our graduating final-year studets and bid farewell to dear friends.</p>
      </div>
      <Footer2 />
    </>
  );
